...
/*
 * Note 1. OR it could be start+(end-start)/2 to resolve the integer limit
 * issue. because start+end could overflows the limit of integer, even though
 * start and end are within limits individually.
 *
 *
 */
